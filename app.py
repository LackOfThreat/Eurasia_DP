...
if __name__ == "__main__":
    st.set_page_config(page_title="Eurasia",
                   page_icon="💸",
                   layout="wide")
    link = "https://drive.google.com/file/d/1-0DqAZ4QDiADKggalyIVuDeqlVZqrXb3/view?usp=sharing"
    file = download_file_from_google_drive("1-0DqAZ4QDiADKggalyIVuDeqlVZqrXb3").content
    ...
    # kiev_now = datetime.fromtimestamp(1639230552)
    ...
    st.title("Предсказание заказов - Eurasia")
    spot = st.selectbox("Точка", ['Нивки'])
